...
<head>
    ...
    <body>
        ...
        <div class="row">
          ...
          <div>
            <h3 class='border border-1 border-#dee2e6 p-3 bg-light'>modification des Poemes</h3>
          </div>
            <table>
              <style>
                table{
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a href="<?= base_url().'Poemes/modification/'.$row['id']?>" class='btn btn-warning p-1 text-decoration-none'>Modifier</a></td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
               </table>
