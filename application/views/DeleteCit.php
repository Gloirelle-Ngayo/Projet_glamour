...
<body>
    ...
    <div class="row">
       ...
       <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-3" style="z-index: 100"> 
          <div>
            <h3 class='border border-1 border-#dee2e6 p-3 bg-light'>Suppression des Citations</h3>
          </div>
            <table>
              <style>
                table{
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a href="<?= base_url().'Citations/delete/'.$row['id']?>" class='btn btn-danger p-1 text-decoration-none'>Supprimer</a></td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
               </table>
