  ...
  <body>
    <header class="navbar navbar-dark sticky-top  flex-md-nowrap p-0 shadow bg-dark" >
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-3" style="z-index: 100"> 
          <div>
            <h3 class='border border-1 border-#dee2e6 p-3 bg-light'>modification des Proverbes</h3>
          </div>
            <table>
              <style>
                table{
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a href="<?= base_url().'Proverbes/modification/'.$row['id']?>" class='btn btn-warning p-1 text-decoration-none'>Modifier</a></td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
               </table>
