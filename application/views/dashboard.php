...
<header class="navbar navbar-dark sticky-top  flex-md-nowrap p-0 shadow bg-dark" >
  ...
  <div class="navbar-nav  ">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-3" style="z-index: 100"> 
      <div class="row">
        <div class="col-md-3">
            <div class="card bg-primary h-100" style="width: 16rem;">
              <div class="card-body">
          ...
          <div class="col-md-3">
          <div class="card bg-info h-100" style="width: 16rem;">
              <div class="card-body">
          ...
          <div class="col-md-3">
          <div class="card bg-success h-100" style="width: 16rem;">
              <div class="card-body">
          ...
          <div class="col-md-3">
          <div class="card bg-warning h-100" style="width: 16rem;">
              <div class="card-body">
